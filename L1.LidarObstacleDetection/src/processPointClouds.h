...
public:
    ...
    // Add for rubric requirements
    std::vector<typename pcl::PointCloud<PointT>::Ptr> ClusteringRubric(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize);
